...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    code: "<button type=\"button\" class=\"border text-blue-500 border-blue-500 hover:bg-blue-500 hover:text-white py-2 px-3 rounded\">Primary</button>\n<button type=\"button\" class=\"border text-gray-600 border-gray-600 hover:bg-gray-600 hover:text-white py-2 px-3 rounded\">Secondary</button>\n<button type=\"button\" class=\"border text-green-600 border-green-600 hover:bg-green-600 hover:text-white py-2 px-3 rounded\">Success</button>\n<button type=\"button\" class=\"border text-red-600 border-red-600 hover:bg-red-600 hover:text-white py-2 px-3 rounded\">Danger</button>\n<button type=\"button\" class=\"border text-yellow-500 border-yellow-500 hover:bg-yellow-500 hover:text-white py-2 px-3 rounded\">Warning</button>\n<button type=\"button\" class=\"border text-teal-500 border-teal-500 hover:bg-teal-500 hover:text-white py-2 px-3 rounded\">Info</button>\n<button type=\"button\" class=\"border text-gray-200 border-gray-200 hover:bg-gray-200 hover:text-black py-2 px-3 rounded\">Light</button>\n<button type=\"button\" class=\"border text-gray-800 border-gray-800 hover:bg-gray-800 hover:text-white py-2 px-3 rounded\">Dark</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
    },
...
//# sourceMappingURL=buttons.js.eece4113e34240479902.hot-update.js.map