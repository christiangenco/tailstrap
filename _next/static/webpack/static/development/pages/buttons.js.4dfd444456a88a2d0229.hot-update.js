...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    code: "<button type=\"button\" class=\"text-xs py-2 px-4 bg-blue-500 hover:bg-blue-700 text-blue-100 rounded\">Primary</button>\n<button type=\"button\" class=\"text-xs py-2 px-4 bg-gray-600 hover:bg-gray-700 text-white rounded\">Secondary</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98
    },
...
//# sourceMappingURL=buttons.js.4dfd444456a88a2d0229.hot-update.js.map