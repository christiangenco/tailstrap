...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    code: "<button type=\"button\" class=\"bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded\">Primary</button>\n<button type=\"button\" class=\"bg-gray-500 hover:bg-gray-700 text-white py-1 px-2 rounded\">Secondary</button>\n<button type=\"button\" class=\"btn btn-success\">Success</button>\n<button type=\"button\" class=\"btn btn-danger\">Danger</button>\n<button type=\"button\" class=\"btn btn-warning\">Warning</button>\n<button type=\"button\" class=\"btn btn-info\">Info</button>\n<button type=\"button\" class=\"btn btn-light\">Light</button>\n<button type=\"button\" class=\"btn btn-dark\">Dark</button>\n\n<button type=\"button\" class=\"btn btn-link\">Link</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23
    },
...
//# sourceMappingURL=buttons.js.53bdf27f3c07243ab372.hot-update.js.map