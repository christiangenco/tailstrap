...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    __self: this
  }, ".text-xs"), " with padding bumped up or down. See", " ", __jsx(_components_Elements__WEBPACK_IMPORTED_MODULE_2__["A"], {
    ...
    code: "<button type=\"button\" class=\"text-2xl py-2 px-4 bg-blue-500 hover:bg-blue-700 text-blue-100 rounded\">Large button</button>\n<button type=\"button\" class=\"text-2xl py-2 px-4 bg-gray-600 hover:bg-gray-700 text-white rounded\">Large button</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 93
    },
    __self: this
  }), __jsx(_components_Example__WEBPACK_IMPORTED_MODULE_1__["default"], {
    code: "<button type=\"button\" class=\"text-xs py-1 px-2 bg-blue-500 hover:bg-blue-700 text-blue-100 rounded\">Small button</button>\n<button type=\"button\" class=\"text-xs py-1 px-2 bg-gray-600 hover:bg-gray-700 text-white rounded\">Small button</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98
    },
    __self: this
  }), __jsx(_components_Elements__WEBPACK_IMPORTED_MODULE_2__["P"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 103
    },
    __self: this
  }, "Create block level buttons\u2014those that span the full width of a parent\u2014by adding ", __jsx(_components_Elements__WEBPACK_IMPORTED_MODULE_2__["Code"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 105
    },
    __self: this
  }, ".block"), "."), __jsx(_components_Example__WEBPACK_IMPORTED_MODULE_1__["default"], {
    code: "<button type=\"button\" class=\"block py-2 px-3 bg-blue-500 hover:bg-blue-700 text-blue-100 rounded\">Block level button</button>\n<button type=\"button\" class=\"block py-2 px-3 bg-gray-600 hover:bg-gray-700 text-white rounded\">Block level button</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108
    },
...
//# sourceMappingURL=buttons.js.366abb5208595843aa18.hot-update.js.map