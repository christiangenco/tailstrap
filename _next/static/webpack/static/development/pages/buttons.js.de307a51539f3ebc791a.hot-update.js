...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    code: "<button type=\"button\" class=\"hover:bg-blue-500 hover:text-white py-2 px-3 rounded\">Primary</button>\n<button type=\"button\" class=\"hover:bg-gray-600 hover:text-white py-2 px-3 rounded\">Secondary</button>\n<button type=\"button\" class=\"hover:bg-green-600 hover:text-white py-2 px-3 rounded\">Success</button>\n<button type=\"button\" class=\"hover:bg-red-600 hover:text-white py-2 px-3 rounded\">Danger</button>\n<button type=\"button\" class=\"hover:bg-yellow-500 hover:text-white py-2 px-3 rounded\">Warning</button>\n<button type=\"button\" class=\"hover:bg-teal-500 hover:text-white py-2 px-3 rounded\">Info</button>\n<button type=\"button\" class=\"hover:bg-gray-200 hover:text-black py-2 px-3 rounded\">Light</button>\n<button type=\"button\" class=\"hover:bg-gray-800 hover:text-white py-2 px-3 rounded\">Dark</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
    },
...
//# sourceMappingURL=buttons.js.de307a51539f3ebc791a.hot-update.js.map