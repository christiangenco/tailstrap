...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx("div", {
    ...
    __self: this
  }, "bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded inline-block cursor-pointer"), " ", "classes may be used with the ", __jsx(_components_Elements__WEBPACK_IMPORTED_MODULE_2__["Code"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44
    },
    ...
    code: "<a class=\"bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded inline-block\" href=\"#\" role=\"button\">Link</a>\n<button class=\"bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded\" type=\"submit\">Button</button>\n<input class=\"bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded cursor-pointer\" type=\"button\" value=\"Input\">\n<input class=\"bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded cursor-pointer\" type=\"submit\" value=\"Submit\">\n<input class=\"bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded cursor-pointer\" type=\"reset\" value=\"Reset\">",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58
    },
    ...
    __self: this
  }, "Outline buttons"), __jsx(_components_Example__WEBPACK_IMPORTED_MODULE_1__["default"], {
    code: "<button type=\"button\" class=\"text-blue-500 border-blue-500 hover:bg-blue-500 hover:text-white py-2 px-3 rounded\">Primary</button>\n<button type=\"button\" class=\"text-gray-600 border-gray-600 hover:bg-gray-600 hover:text-white py-2 px-3 rounded\">Secondary</button>\n<button type=\"button\" class=\"text-green-600 border-green-600 hover:bg-green-600 hover:text-white py-2 px-3 rounded\">Success</button>\n<button type=\"button\" class=\"text-red-600 border-red-600 hover:bg-red-600 hover:text-white py-2 px-3 rounded\">Danger</button>\n<button type=\"button\" class=\"text-yellow-500 border-yellow-500 hover:bg-yellow-500 hover:text-white py-2 px-3 rounded\">Warning</button>\n<button type=\"button\" class=\"text-teal-500 border-teal-500 hover:bg-teal-500 hover:text-white py-2 px-3 rounded\">Info</button>\n<button type=\"button\" class=\"text-gray-200 border-gray-200 hover:bg-gray-200 hover:text-black py-2 px-3 rounded\">Light</button>\n<button type=\"button\" class=\"text-gray-800 border-gray-800 hover:bg-gray-800 hover:text-white py-2 px-3 rounded\">Dark</button>",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
    },
...
//# sourceMappingURL=buttons.js.799f1a698958001a8380.hot-update.js.map